...
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE = CUSTOM_TRAN_PCBA CUSTOM_TRAN_CAM_MATERIAL_CODE CUSTOM_TRAN_PROJECT CUSTOM_TRAN_BOM CUSTOM_HAL_LENS BOOT_LOGO MTK_AUDIO_BLOUD_CUSTOMPARAMETER_REV MTK_PLATFORM CUSTOM_KERNEL_LENS CUSTOM_KERNEL_MAIN_BACKUP_LENS MTK_MODEM_SUPPORT CUSTOM_KERNEL_MAIN_IMGSENSOR MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_IMGSENSOR CUSTOM_KERNEL_SUB_LENS CUSTOM_KERNEL_IMGSENSOR MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_SUB_BACKUP_LENS CUSTOM_KERNEL_MAIN_LENS MTK_FM_CHIP CUSTOM_KERNEL_MAIN2_IMGSENSOR BOOT_LOGO
#BSP:modify BBSHLYYW-1 by chenglong.jiang 20190724 start
BOOT_LOGO = hdplus1600
#BSP:modify BBSHLYYW-1 by chenglong.jiang 20190724 end
BUILD_AGO_GMS = yes
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_BUILD_VERNO = CY-BB4K-H6114-U
...
#ITD: Modify Camera BringUp By Jesse 190802 Start
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = constant_flashlight
CUSTOM_TRAN_PCBA = tran_pcba_h6114
CUSTOM_HAL_IMGSENSOR = gc8034main_mipi_raw gc8034_mipi_raw pblcgc8034main_mipi_raw pblcgc8034_mipi_raw
CUSTOM_TRAN_CAM_MATERIAL_CODE = gc8034_17201607 gc8034_17201572
...
#ITD: Modify Camera BringUp By Jesse 190802 End
#BSP: add BBSHLYYW-6 by kangping.liu for 20190726 start
CUSTOM_HAL_MSENSORLIB = akl akm
#BSP: add BBSHLYYW-6 by kangping.liu for 20190726 end
...
#BSP: add BBSHLYYW-6 by kangping.liu for 20190726 start
#BSP:add XLWSHBLEB-30  by ming.chen 20190722 start
TRAN_LED_BLUE_SUPPORT=yes
#BSP:add XLWSHBLEB-30  by ming.chen 20190722 end
...
#TSD:Modify XLWSHBLEB-22 by yong.chen1 20190723 start
CUSTOM_MODEM = bb4_h6114
#TSD:Modify XLWSHBLEB-22 by yong.chen1 20190723 end
...
#BSP:modify BBSHLYYW-3 shuanglei.wang 20190725 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify BBSHLYYW-3 shuanglei.wang 20190725 end
...
#modify by yehui.xu for BBSHLYYW-17 20190807 start
MTK_BUILD_VERNO=BB4k-H6114UVW-PGo-200112V66
FINGERPRINT_BUILD_VERNO=UVW-200112V66
#modify by yehui.xu for BBSHLYYW-17 20190807 end
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
#BSP:add KCLHLYYY-5 by yongxian.wang 20180905 start
MTK_DUAL_CHARGER_SUPPORT = no
TRAN_DUAL_LINEAR_CHARGER = yes
#BSP:add KCLHLYYY-5 by yongxian.wang 20180905 end
...
#TSD Modify enable_Vowifi BBSJHLYYS-134 by yong.chen1 20191029 start
MTK_EPDG_SUPPORT = yes
#TSD Modify enable_Vowifi BBSJHLYYS-134 by yong.chen1 20191029 end
MTK_ESN_TRACK_APP = no
MTK_ETHERNET_SUPPORT = no
#TSD: modify by  BBSHLYYW-18 by jiangerji 20190812 start
MTK_ETWS_SUPPORT = yes
#TSD: modify by  BBSHLYYW-18 by jiangerji 20190812 end
...
MTK_FIRST_MD = 1
#TSD:Modify XLWSHBLEB-6 by yong.chen1 20190628 start
MTK_FLIGHT_MODE_POWER_OFF_MD = yes
#TSD:Modify XLWSHBLEB-6 by yong.chen1 20190628 end
MTK_FLIGHT_MODE_POWER_OFF_MD_POLICY = 0
MTK_FLV_PLAYBACK_SUPPORT = yes
#TSD:Modify BBSHLYYW-14 by yunfei.wu 20190628 start
MTK_FMRADIO_APP = yes
...
MTK_FM_SUPPORT = yes
#TSD:Modify BBSHLYYW-14 by yunfei.wu 20190628 end
...
MTK_IRTX_SUPPORT = no
# BSP:modify XLWSHBLEB-57 by ming.chen 20190730 start
MTK_JEITA_STANDARD_SUPPORT = yes
# BSP:modify XLWSHBLEB-57 by ming.chen 20190730 end
...
#TSD:Modify XLWSHBLEB-6 by yong.chen1 20190802 start
MTK_MULTIPLE_IMS_SUPPORT = 2
#TSD:Modify XLWSHBLEB-6 by yong.chen1 20190802 end
...
#BSP: modify for XLELHLES-7 by shentao.yang 20190710 start
#BSP: modify for XLELHLES-7 by shentao.yang 20190710 end
...
#TSD:Modify XLWSHBLEB-6 by yong.chen1 20190723 start
MTK_PROTOCOL1_RAT_CONFIG = Lf/Lt/W/G
MTK_PROTOCOL2_RAT_CONFIG = L/W/G
#TSD:Modify XLWSHBLEB-6 by yong.chen1 20190723 end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
#BSP: modify BBSHLYYW-9 by muduo.qin 20190730 start
MTK_UART_USB_SWITCH = yes
#BSP: modify BBSHLYYW-9 by muduo.qin 20190730 end
MTK_UCE_SUPPORT = no
MTK_UFS_BOOTING = no
MTK_UFS_OTP = no
...
#TSD: modify BBSHLYYW-61 by hailou.xu 20190827 start
MTK_WFD_SUPPORT = yes
#TSD: modify BBSHLYYW-61 by hailou.xu 20190827 end
...
#BSP: add custom macro by wanghanfeng 20190628 start
TRAN_SYSTEM_DEVINFO = yes
CUSTOM_TRAN_PROJECT=tran_bb4k
CUSTOM_TRAN_BOM=tran_bb4k_u1
...
#BSP: add custom macro by wanghanfeng 20190628 end
#BSP: modify BBSHYYW-51 by qiaoqiao.pan 20190822 start
TRAN_FINGERPRINT_SUPPORT = sunwave_tee chipone_tee focaltech_tee
#BSP: modify BBSHYYW-51 by qiaoqiao.pan 20190822 end

################# ITD Camera Driver start #######################
#ITD:add cam 3pty function by shoufeng.zhao 20190820 start
TRAN_CAMERA_FEATURE = yes
#ITD:add cam 3pty function by xiaoxue.cai 20190820 end
#ITD: add XLWSCHLYYY-56 by yang.li3  20190820 start
TRAN_FLASH_SLIDE_CONTROL = yes
#ITD: add XLWSCHLYYY-56 by yang.li3  20190820 end
#ITD:add for CAM_SKIN_COMPATIBLE BBSHLYYW-143 by desuo.lu 20190902 start
TRAN_CAM_SKIN_COMPATIBLE = yes
#ITD:add for CAM_SKIN_COMPATIBLE BBSHLYYW-143 by desuo.lu 20190902 end
#ITD: add for thirdpart apk BBSHLYYW-352 by desuo.lu 20190925 start
TRAN_CAMERA_THIRDPART = yes
#ITD: add for thirdpart apk BBSHLYYW-352 by desuo.lu 20190925 end
################## ITD Camera Driver end #######################

#TSD:modify BBSHLYYW-98 sihai.jia 20190828 start
TRAN_SHORT_ANTENNA_SUPPORT=yes
#TSD:modify BBSHLYYW-98 sihai.jia 20190828 end
#BSP: add BBSHLYYW-502 by tao.lan 20191024 start
TRAN_PS_CALI_FAC = yes
#BSP: add BBSHLYYW-502 by tao.lan 20191024 end
